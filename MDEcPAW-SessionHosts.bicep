...
param OnboardMDEUrl string
param OnboardMDEUrlCmd string
...
// Onboard the Session Hosts to MDE
resource mdeExtension 'Microsoft.Compute/virtualMachines/extensions@2021-03-01' = [for i in range(0, numberOfHosts): {
  parent: VM[i]
  name: '${sessionHostPrefix}-${i}-MDEExtension'
  location: resourceGroup().location
  properties: {
